...
public class DateUtil {
   ...
   public static Long getMicroTimestamp() {
		...
		Long micortime= cutime + (nanoTime - nanoTime / 1000000 * 1000000) / 1000;
		System.out.println(cutime);
		System.out.println(nanoTime);
		System.out.println(micortime);
   ...
   public static Long getNanoTimestamp() {
	    ...
	    Long nanotime = systime * 1000000; // 微秒
	    nanotime=nanotime+(inano++)%1000000;
		//System.out.println("systime:"+systime+"\nnanotime"+nanotime);
	    return nanotime;
  }
   
   
   public static String getNanoTimestampDes(Long time) {
	   Long timedate=time/1000000;
	   Long timenano=time%1000000; 
	   SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
       return  sdf.format(new Date(timedate))+String.format(".%06d%n",timenano);
